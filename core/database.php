...
class DB {
  ...
  /**
   * The first parameter is a query string with placeholders variables. Following that, you must have an additional parameter for every placeholder variable.<br><br>
   * If you need to refer to a specific parameter, rather than just getting them in the order that they were passed in, you can put a number after the placeholder. The first parameter passed will have number 0. You can even re-use the same parameter multiple times! <br><br>
   * You can also pass in an array of named parameters. These will be accessed through placeholders of the form %s_somename, %i_somenumber, and the like.<br><br>
   * <b>Placeholder Variables</b><br><pre>
    %s      string
    %i      integer
    %d      decimal/double
    ...
    %ll     list of literals (no escaping or parsing of any kind -- BE CAREFUL)</pre>
   * 
   * @link http://www.meekro.com/docs.php#anchor_query
   * @return array Returns an array of associative arrays. If your query produced no results, you get an empty array.
   */
   ...
   * @link http://www.meekro.com/docs.php#anchor_queryfirstrow
   */
   ...
   * @link http://www.meekro.com/docs.php#anchor_queryfirstlist
   */
   ...
   * @link http://www.meekro.com/docs.php#anchor_queryfirstcolumn
   */
   ...
   * @link http://www.meekro.com/docs.php#anchor_queryonecolumn
   */
   ...
   * @link http://www.meekro.com/docs.php#anchor_queryfirstfield
   */
   ...
   * @link http://www.meekro.com/docs.php#anchor_queryonefield
   */
   ...
   * @link http://www.meekro.com/docs.php#anchor_queryraw
   */
  ...
  /**
   * Either INSERT or REPLACE a row into a table. You can use DB::sqleval() to force something to be passed directly to MySQL and not escaped. You may insert multiple rows at once by passing an array of associative arrays.
   * @link http://www.meekro.com/docs.php#anchor_insert
   */
   ...
   * @link http://www.meekro.com/docs.php#anchor_insertignore
   */
   ...
   * @link http://www.meekro.com/docs.php#anchor_insertupdate
   */
   ...
   * @link http://www.meekro.com/docs.php#anchor_update
   */
   ...
   * @link http://www.meekro.com/docs.php#anchor_delete
   */
   ...
   * @link http://www.meekro.com/docs.php#anchor_insertid
   */
   ...
   * @link http://www.meekro.com/docs.php#anchor_count
   */
  ...
  /**
   * @link http://www.meekro.com/docs.php#anchor_nested_transactions
   */
  ...
  /**
   * @link http://www.meekro.com/docs.php#anchor_debugmode
   */
